 ...
 * @author VINICIUS
 */
public class FullModeSeven implements KeyListener {
    ...
    public void render() throws IOException {
        ...
        BufferedImage texture = ImageIO.read(new File("src/resources/texture3.png"));
