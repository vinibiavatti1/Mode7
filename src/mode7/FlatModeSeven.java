...
/**
 * Mode 7 - Flat Movement Implementation
 *
 * @author VINICIUS
 */
public class FlatModeSeven implements KeyListener {
    ...
    public void render() throws IOException {
        ...
        BufferedImage texture = ImageIO.read(new File("src/resources/texture5.png"));
        ...
        while (true) {
            ...
            //Render Sky
            for (int y = 0; y < HEIGHT_CENTER; y++) {
                for (int x = 0; x < WIDTH; x++) {
                    pixels[x + y * WIDTH] = new Color(100,170,255).getRGB();
                }
            }
